...
date: 2018-06-25
excerpt: I created this post for those who are unfamiliar with the syntax of
  Markdown. People who are already similar with Markdown should also check this
  post because I use some special plugins that provide additional features. 2
...
[You can use numbers for reference-style link definitions](https://www.mozilla.org)

Or leave it empty and use the [link text itself](https://www.mozilla.org).
